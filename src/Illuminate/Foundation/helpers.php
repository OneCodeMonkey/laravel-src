...
if (!function_exists('action')) {
    /**
     * Generate th URL to a controller action.
     *
...
if (!function_exists('bcrypt')) {
    /**
     * Hash the given value against the bcrypt algorith,
     *
     * @param string $value
     * @param array $options
     * @return string
...
if (!function_exists('cache')) {
     ...
     *
     * @params dynamic key|key, default|data,expiration|null
...
if (!function_exists('csrf_field')) {
    /**
     * Generate a CSRF toen from field.
     *
...
if (!function_exists('method_field')) {
    ...
    {
        return new HtmlString('< type="hidden" name="_method" value="'.$method.'">');
    }
}
...
if (!function_exists('rescue')) {
    ...
    function rescue(callable $callback, $rescue = null, $report = true)
    {
        try {
            ...
            return $report instanceof Closure ? $report($e) : $rescue;
        }
    }
}
...
if (!function_exists('response')) {
     ...
     *
     * @param \Illuminate\View\View|array|null|string $content
     * @param int $status
     * @param array $headers
...
if (!function_exists('validator')) {
    ...
    function validator(array $data = [], array $rules = [], array $messages = [], array $customAttributes = [])
    {
        ...
        return $factory->make($data, $rules, $message, $customAttributes);
    }
}
