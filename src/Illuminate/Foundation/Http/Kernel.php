...
class Kernel implements KernelContract
{
    ...
    /**
     * Bootstrap the appliation for HTTP requests.
     *
     * @return void
     */
    ...
    /**
     * Add a new middleware to beginning of the stack if it doesn't already exist.
     *
     * @param string $middleware
     * @return $this
     */
    ...
    /**
     * Add a new middleware to end of the stack if it doesn't already exist.
     *
     * @param string $middleware
     * @return $this
     */
