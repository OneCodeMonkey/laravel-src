...
trait MakesHttpRequests
{
    ...
    /**
     * Set the referer header and previous URL sessionn value in order to simulate a previous request.
     *
     * @param string $url
     * @return $this
     */
     ...
     * @return \Illuminate\Foundation\Testing\TestResponse|\Illuminate\Http\Response
     */
