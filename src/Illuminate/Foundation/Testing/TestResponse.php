...
class TestResponse implements ArrayAccess
{
    ...
    /**
     * Assert that the response contains the given cookie and equals the optional value.
     *
    ...
    protected function assertJsonMessage(array $data)
    {
        ...
        return 'Unable to find JSON: '.PHP_EOL.PHP_EOL."[{$expected}]".PHP_EOL.PHP_EOL.'within response JSON:'.PHP_EOL.
            PHP_EOL."[{$actual}].".PHP_EOL.PHP_EOL;
    }
    ...
    public function assertJsonFragment(array $data)
    {
        ...
        foreach (Arr::sortRecursive($data) as $key => $value) {
            ...
            PHPUnit::assertTrue(
                ...
                'Unable to find JSON fragment: '.PHP_EOL.PHP_EOL.'['.json_encode([$key => $value]).']'.PHP_EOL.PHP_EOL.
                'within'.PHP_EOL.PHP_EOL."[{$actual}]."
            );
        }
    ...
    public function assertJsonValidationErrors($errors, $responseKey = 'errors')
    {
        ...
        $errorMessage = $jsonErrors ? 'Response has the following JSON validation errors:'.
            PHP_EOL.PHP_EOL.json_encode($jsonErrors, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES |
                JSON_UNESCAPED_UNICODE).PHP_EOL : 'Response does not have JSON validation errors.';
    ...
    /**
     * Assert that the response has no JSON validation errors for the given key.
     *
