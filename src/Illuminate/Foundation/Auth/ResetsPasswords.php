...
trait ResetsPasswords
{
    ...
    public function reset(Request $request)
    {
        ...
        // Here we will attempt to reset the user's password. If it is successful we will update the password
        // on an actual user model and persist it to the database. Otherwise we will parse the error and return
        // the response.
