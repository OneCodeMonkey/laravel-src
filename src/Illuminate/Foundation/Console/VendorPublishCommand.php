...
class VendorPublishCommand extends Command
{
    ...
    protected $signature = 'vendor:publish {--force : Overwrite any existing files} 
                                ...
                                {--provider= : The srevice provider that has assets you want to publish}
    ...
    {
        $choice = $this->choice("Which provider or tag's files would you like to publish?",
    ...
    {
        return array_merge(
            ['<comment>Publish files from all providers and tag listed below</comment>'],
    ...
    /**
     * Move al the files in the given MountManager.
     *
