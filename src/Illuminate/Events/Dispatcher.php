...
class Dispatcher implements DispatcherContract
{
    ...
    {
        // When the given "event" is actually an object we will assume it is an event object and use the class as the
        // event name and this event itself as the payload to the handler, which makes object based events quite
        // simple.
        ...
        foreach ($this->getListeners($event) as $listener) {
            ...
            // If a boolean false is returned from a listener, we will stop propagating the event to any further
            // listeners down in the chain, else we keep on looping through the listeners and firing every one in our
            // sequence.
            if ($response === false) {
                break;
            }
     ...
     * @return \Closure
     */
    protected function createQueuedHandlerCallback($class, $method)
    {
