...
class MailFake implements Mailer, MailQueue
{
     ...
     * @return void
     */
    protected function assertSendTimes($mailable, $times = 1)
    {
        PHPUnit::assertTrue(
    ...
    public function assertQueued($mailable, $callback = null)
    {
        ...
        PHPUnit::assertTrue(
            ...
            "The unexpected [{$mailable}] mailable was not queued."
        );
    }
    ...
    protected function assertQueuedTimes($mailable, $times = 1)
    {
        PHPUnit::assertTrue(
            ...
            "The expected [{$mailable}] mailable was queued {$count} times instead of {$times} tiems."
        );
    }
    ...
    /**
     * Assert that not mailables were queued.
     *
     * @return void
     */
    ...
    /**
     * Get all of the mailed mailables fo a given type.
     *
     * @param string $type
     * @return \Illuminate\Support\Collection
     */
