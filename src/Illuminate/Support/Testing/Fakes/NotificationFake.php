...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
     ...
     * @return void
     */
    public function assertSendTo($notifiable, $notification, $callback = null)
    {
        if (is_array($notifiable) || $notifiable instanceof Collection) {
            foreach ($notifiable as $singleNotifiable) {
                $this->assertSendTo($singleNotifiable, $notification, $callback);
            }
        ...
        if (is_numeric($callback)) {
            return $this->assertSendToTimes($notifiable, $notification, $callback);
        }
    ...
    /**
     * Determine if there are more notifications left tuo inspect.
     *
     * @param mixed $notifiable
     * @param string $notification
     * @return bool
    ...
    /**
     * Send the givn notification to the given notifiable entities.
     *
