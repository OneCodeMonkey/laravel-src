...
class Str
{
    ...
    public static function is($pattern, $value)
    {
        ...
        foreach ($patterns as $pattern) {
            // If the given value is an exact match we can of course return true or right from the beginning.
            // Otherwise, we will translate asterisks and do an actual pattern match against the two strings
