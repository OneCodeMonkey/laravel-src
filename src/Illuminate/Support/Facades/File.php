 ...
 * @method static string shareGet(string $path)
 ...
 * @method static void like(string $target, string $link)
 ...
 * @method static bool copyDirectory(string $directory, string $to, bool $overwrite = false)
