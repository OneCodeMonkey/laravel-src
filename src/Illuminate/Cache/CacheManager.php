...
class CacheManager implements FactoryContract
{
    ...
    protected function createMemcachedDriver(array $config)
    {
        ...
        $memcached = $this->app['memcached_connector']->connect(
            $config['servers'],
    ...
    protected function createDatabaseDriver(array $config)
    {
        ...
        return $this->repository(
            new DatabaseStore($connection, $config['table'], $this->getPrefix($config))
        );
    }
    ...
    /**
     * Dynamically call the defalt driver instance.
     *
     * @param string $method
