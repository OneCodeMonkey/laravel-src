...
class RedisStore extends TaggableStore implements LockProvider
{
    ...
    {
        return (bool)$this->connection()->setex($this->prefix.$key, (int)max(1, $seconds), $this->serialize($value));
    }
    ...
    public function add($key, $value, $seconds)
    {
        ...
        return (bool)$this->connection()->eval($lua, 1, $this->prefix.$key, $this->serialize($value),
            (int)max(1, $seconds));
    }
    ...
    {
        return is_array($value) ? $value : serialize($value);
    }
