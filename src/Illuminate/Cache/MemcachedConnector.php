...
class MemcachedConnector
{
    ...
    public function connect(array $servers, $connectionId = null, array $options = [], array $credentials = [])
    {
        ...
        if (!$memcached->getServerList()) {
            // For each server in the array, we'll just extract the configuration and add the server to the Memcached
            // connection. Once we have added all of these servers we'll verify the connection is successful and
            // return it back.
