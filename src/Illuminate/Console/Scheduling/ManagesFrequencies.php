...
trait ManagesFrequencies
{
    ...
    /**
     * Schedule the event to run daily at a given time(10:00, 19:30, ...)
     *
     * @param string $time
     * @return $this
     */
     ...
     *
     * @param \DateTimeInterface|string $timezone
     * @return $this
     */
    ...
    /**
     * Splice the given value into the given position for the expression.
     *
     * @param int $position
     * @param string $value
     * @return $this
