...
class Collection extends BaseCollection implements QueueableCollection
{
    ...
    /**
     * Load a set of relationships onto the mxied relationship collection.
     *
    ...
    /**
     * Collapse the collection of items onto a single array.
     *
     * @return \Illuminate\Support\Collection
     */
    ...
    /**
     * Get the comparision function to detect duplicates.
     *
     * @param bool $strict
     * @return \Closure
     */
    ...
    public function getQueueableIds()
    {
        ...
        return $this->first() instanceof QueueableEntity ? $this->map->getQueueableId()->all() :
            $this->modelKeys();
    }
