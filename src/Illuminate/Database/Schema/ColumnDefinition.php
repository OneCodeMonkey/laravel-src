 ...
 * @method ColumnDefinition collation(string $collation) Specify a collation for the column (MySQL/PostgreSQL/SQL \
 * Server)
 ...
 * @method ColumnDefinition generatedAs(string|Expression $expression = null) Create a SQL compliant identity column \
 * (PostgreSQL)
 ...
 * @method ColumnDefinition virtualAs(string $expression) Create a virtual generateed column (MySQL)
