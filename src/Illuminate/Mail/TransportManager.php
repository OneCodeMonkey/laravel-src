...
class TransportManager extends Manager
{
    ...
    protected function createSmtpDriver()
    {
        ...
        // The Swift SMTP transport instance will allow us to use any SMTP backend for delivering mail such as
        // Sendgrid, Amazon SES, or a custom server a developer has available. We will just pass this configured host.
        ...
        // Once we have the transport we will check for the presence of a username and password. If we have it we will
        // set the credentials on the Swift transporter instance so that we'll properly authenticate delivery.
