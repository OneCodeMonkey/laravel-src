...
class Manager
{
    ...
    /**
     * Create a new queue capsure manager.
     *
    ...
    public function __construct(Container $container = null)
    {
        ...
        // Once we have the container setup, we will setup the default configuration options in the container
        // "config" bindings. This just makes this queue manager behave correctly since all the correct binding
        // are in place.
