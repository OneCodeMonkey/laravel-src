...
class RedisJob extends Job implements JobContract
{
    ...
    public function __construct(Container $container, RedisQueue $redis, $job, $reserved, $connectionName, $queue)
    {
        ...
        // the $reserved variable is the raw JSON in the reserved queue. The exact format of the
        // reserved job is required in order for us to properly delete its data.
