...
class Listener
{
    ...
    /**
     * The environment the worker should run under.
     *
     * @var string
     */
    ...
    public function makeProcess($connection, $queue, ListenerOptions $options)
    {
        ...
        // If the environment is set, we will append it to the command array so the workers will run under the
        // specified environment. Otherwise, they will just run under the production environment which is not
        // always right.
