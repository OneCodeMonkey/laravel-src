...
LUA;
    ...
    /**
     * Get the Lua script for the popping the next job off of the queue.
     *
     * KEYS[1] - The queue to pop jobs from, for example: queues:foo
     * KEYS[1] - The queue to place reserved jobs on, for example: queues: foo:reserved
     * KEYS[1] - The notify queue
...
LUA;
    ...
    /**
     * Get the Lua script to migrate expired jobs back into the queue.
     *
