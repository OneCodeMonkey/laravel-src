...
class DynamoDbFailedJobProvider implements FailedJobProviderInterface
{
    ...
    public function log($connection, $queue, $payload, $exception)
    {
        ...
        $this->dynamo->putItem([
            ...
            'Item' => [
                ...
                'expires_at' => ['N' => (string)$failedAt->addDay(3)->getTimestamp()],
            ],
        ]);
    ...
    public function find($id)
    {
        ...
        return (object)[
            ...
            'failed_at' => Carbon::createFromTimestamp((int)$result['Item']['failed_at']['N'])
            ->format(DateTimeInterface::ISO8601),
        ];
    }
    ...
    {
        throw new Exception("DynamoDb failed job storage may not be flushed. Please use DynamoDb's TTL features 
        on your expires_at attribute.");
    }
}
