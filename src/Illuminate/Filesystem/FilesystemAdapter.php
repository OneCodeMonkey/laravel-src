...
class FilesystemAdapter implements CloudFilesystemContract
{
    ...
    public function put($path, $contents, $options = [])
    {
        ...
        // If the given contents is actually a file or uploaded file instance then we will automatically store the
        // file using a stream. This provides a convenient path for the developer to store streams without managing
        // them manually in code.
    ...
    public function putFileAs($path, $file, $name, $options = [])
    {
        ...
        // Next, we will format the path of the file and store the file using a stream since they provide better
        // performance than alternatives. Once we write the file this stream will get closed automatically by us so
    ...
    {
        // If an explicit base URL has been set on the disk configuration then we will use it as the base URL instead
        // of the default path. This allows the developer to have full control over the base path for this
        // filesystem's generated URLs.
    ...
    protected function getLocalUrl($path)
    {
        ...
        // If the path contains 'storage/public', it probably means the developer is using the default disk to
        // generate the path instead of the "public" disk like they are really supposed to use. We will remove the
        // public from this path here.
    ...
    /**
     * Pass dynamica methods call into Flysystem.
     *
     * @param string $method
