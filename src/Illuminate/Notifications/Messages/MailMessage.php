...
class MailMessage extends SimpleMessage implements Renderable
{
    ...
    {
        return is_array($address) || $address instanceof Arrayable || $address instanceof Traversable;
    }
    ...
    public function render()
    {
        ...
        return Container::getInstance()->make(Markdown::class)->render($this->markdown, $this->data());
    }
