...
class MessageSelector
{
     ...
     *
     * The plural rules are derived from code of the Zend Framework (2010-09-25), which is subject to the new BSD
     * license(https://framework.zend.com/license)
    ...
    public function getPluralIndex($locale, $number)
    {
        switch ($locale) {
            ...
            case 'uk':
            case 'uk_UA':
                return (($number % 10 == 1) && ($number % 100 != 11)) ? 0 : ((($number % 10 >= 2) &&
            ...
            case 'sl':
            case 'sl_SI':
                return ($number % 100 == 1) ? 0 : (($number % 100 == 2) ? 1 : ((($number % 100 == 3) ||
                    ($number % 100 == 4)) ? 2 : 3));
            case 'mk':
            case 'mk_MK':
            ...
            case 'mt':
            case 'mt_MT':
                return ($number == 1) ? 0 : ((($number == 0) || (($number % 100 > 1) && ($number % 100 < 11))) ? 1 :
            ...
            case 'pl':
            case 'pl_PL':
                return ($number == 1) ? 0 : ((($number % 10 >= 2) && ($number % 10 <= 4) && (($number % 100 < 12) ||
                        ($number % 100 > 14))) ? 1 : 2);
            case 'cy':
            case 'cy_GB':
            ...
            case 'ar_TN':
            case 'ar_YE':
                return ($number == 0) ? 0 : (($number == 1) ? 1 : (($number == 2) ? 2 : ((($number % 100 >= 3) &&
                    ($number % 100 <= 10)) ? 3 : ((($number % 100 >= 11) && ($number % 100 <= 99)) ? 4 : 5))));
            default:
                return 0;
        }
    }
