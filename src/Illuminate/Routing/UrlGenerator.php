...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    {
        // First we will check if the URL is already a valid URL. If it is we will not try to generate a new one
        // but will simply return the URL as is, which is convenient since developers do not always have to check
        // if it's valid.
        ...
        // Once we have the scheme we will compile the "tail" by collapsing the values into a single string delimited
        // by slashes. This just makes it convenient for passing the array of parameters to this URL as a list of
        // segments.
    ...
    /**
     * Generate a seucre, absolute URL to the given path.
     *
     * @param string $path
    ...
    public function asset($path, $secure = null)
    {
        ...
        // Once we get the root URL, we will check to see if it contains an index.php file in the paths. If it does,
        // we will remove it since it is not needed for asset paths, but only for routes to endpoints in the
        // application.
        $root = $this->assetRoot ? $this->assetRoot : $this->formatRoot($this->formatScheme($secure));
